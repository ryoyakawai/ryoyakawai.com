...
const oscStructure = [
  ...
  { name: 'nrpn',            itemIdx:  1, startIdx:  0, endIdx:  2, bytes: 3 }, //this.docodeNrpn(oscHex.slice().slice(0, 3)) },
  { name: 'octave',          itemIdx:  2, startIdx:  3, endIdx:  3, bytes: 1 },
  { name: 'semitone',        itemIdx:  3, startIdx:  4, endIdx:  4, bytes: 1 },
  { name: 'fine',            itemIdx:  4, startIdx:  5, endIdx:  5, bytes: 1 },
  { name: 'beat',            itemIdx:  5, startIdx:  6, endIdx:  6, bytes: 1 },
  { name: 'filler1',         itemIdx:  6, startIdx:  7, endIdx:  7, bytes: 1 },
  { name: 'sawtooth',        itemIdx:  7, startIdx:  8, endIdx:  8, bytes: 1 },
  { name: 'triangle',        itemIdx:  8, startIdx:  9, endIdx:  9, bytes: 1 },
  { name: 'square',          itemIdx:  9, startIdx: 10, endIdx: 10, bytes: 1 },
  { name: 'pulseWidth',      itemIdx: 10, startIdx: 11, endIdx: 11, bytes: 1 },
  { name: 'pwmFreq',         itemIdx: 11, startIdx: 12, endIdx: 12, bytes: 1 },
  { name: 'pwmDepth',        itemIdx: 12, startIdx: 13, endIdx: 13, bytes: 1 },
  { name: 'sweepDepth',      itemIdx: 13, startIdx: 14, endIdx: 14, bytes: 1 },
  { name: 'sweepTime',       itemIdx: 14, startIdx: 15, endIdx: 15, bytes: 1 },
  { name: 'breathDepth',     itemIdx: 15, startIdx: 16, endIdx: 16, bytes: 1 },
  { name: 'breathAttain',    itemIdx: 16, startIdx: 17, endIdx: 17, bytes: 1 },
  { name: 'breathCurve',     itemIdx: 17, startIdx: 18, endIdx: 18, bytes: 1 },
  { name: 'breathThreshold', itemIdx: 18, startIdx: 19, endIdx: 19, bytes: 1 },
  { name: 'level',           itemIdx: 19, startIdx: 20, endIdx: 20, bytes: 1 },
]

const filterStructure = [
  { name: 'nrpn',         itemIdx:  1, startIdx:  0, endIdx:  2, bytes: 3 }, //this.docodeNrpn(filterHex.slice().slice(0, 3)),
  { name: 'mode',         itemIdx:  2, startIdx:  3, endIdx:  3, bytes: 1 },
  { name: 'freq',         itemIdx:  3, startIdx:  4, endIdx:  4, bytes: 1 },
  { name: 'q',            itemIdx:  4, startIdx:  5, endIdx:  5, bytes: 1 },
  { name: 'keyFollow',    itemIdx:  5, startIdx:  6, endIdx:  6, bytes: 1 },
  { name: 'breathMod',    itemIdx:  6, startIdx:  7, endIdx:  7, bytes: 1 },
  { name: 'lfoFreq',      itemIdx:  7, startIdx:  8, endIdx:  8, bytes: 1 },
  { name: 'lfoDepth',     itemIdx:  8, startIdx:  9, endIdx:  9, bytes: 1 },
  { name: 'lfoBreath',    itemIdx:  9, startIdx: 10, endIdx: 10, bytes: 1 },
  { name: 'lfoThreshold', itemIdx: 10, startIdx: 11, endIdx: 11, bytes: 1 },
  { name: 'sweepDepth',   itemIdx: 11, startIdx: 12, endIdx: 12, bytes: 1 },
  { name: 'sweepTime',    itemIdx: 12, startIdx: 13, endIdx: 13, bytes: 1 },
  { name: 'breathCurve',  itemIdx: 13, startIdx: 14, endIdx: 14, bytes: 1 },
]
